...
// type and an element of that type and returns the index of the first
// occurrence of v in s, or -1 if not present. The comparable constraint means
// that we can compare values of this type with the == and != operators.
// For a more thorough explanation of this type signature, see this blog post.
...
//AllElements returns all the List elements as a slice. In the next example we’ll
// see a more idiomatic way of iterating over all elements of custom types.
